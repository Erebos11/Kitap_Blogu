...
<body>
  ...
  <main>
    <div class="container  rounded-5 col-9 my-5" style="background: linear-gradient(to right, #614385, #516395);">
        ...
        <div class="col-3 border-end border-2">
          <ul class="nav flex-column">
            <li class="nav-item d-flex align-items-center my-2 ">
              ...
              <a class="mx-2 text-decoration-none text-light fs-5" aria-current="page" href="../anasayfa/index.php">
                Anasayfa
              </a>
            </li>
            <li class="nav-item d-flex align-items-center my-2 ">
              <i class="mx-3 fa-solid fa-address-card "></i>
              <a class="mx-2 text-decoration-none text-light fs-5" href="user_profile.php">Bilgileriniz
              </a>
            </li>
            <!-- <li class="nav-item d-flex align-items-center  my-2 ">
            ...
            <i class=" mx-3 fa-solid fa-comment"></i>              
              <a class="mx-2 text-decoration-none text-light fs-5" href="user_comments.php">Yorumlarınız
              </a>
            </li>
          </ul>
          ...
          <ul class="nav flex-column mb-auto">
            <li class="nav-item d-flex align-items-center my-1 mt-2">
              ...
              <form action="../mysql/logout.php" method="POST">
                <button type="submit" name="logout" class="btn text-light fs-5">Çıkış Yap</button>
              </form>
            </li>
          </ul>
        </div>
